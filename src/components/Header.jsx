  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <Link 
          to="/" 
          className="text-xl sm:text-2xl font-bold text-emerald-600 flex items-center"
          onClick={scrollToTop}
        >
          <BuildingStorefrontIcon className="h-6 w-6 sm:h-7 sm:w-7 mr-2" />
          FOODKART
        </Link>
      ...
      >
        <div className="flex justify-between items-center p-4 border-b">
          <Link 
            to="/" 
            className="text-xl font-bold text-emerald-600 flex items-center"
            onClick={scrollToTop}
          >
        ...
        <nav className="flex flex-col p-4 space-y-4">
          <Link 
            to="/" 
            className="flex items-center text-gray-700 hover:text-emerald-600 font-medium py-2 border-b border-gray-100"
            onClick={scrollToTop}
          >
          ...
          <button 
            className="flex items-center text-gray-700 hover:text-emerald-600 font-medium bg-transparent border-none cursor-pointer py-2 border-b border-gray-100 w-full text-left"
            onClick={scrollToContact}
          >
          ...
          <Link 
            to="/cart" 
            className="flex items-center text-gray-700 hover:text-emerald-600 font-medium py-2 mt-4"
            onClick={scrollToTop}
          >
